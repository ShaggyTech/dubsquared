<template>
  <div class="animate-gears__container">
    <svg
      class="machine"
      x="0px"
      y="0px"
...
.animate-gears__container {
  --small-speed: 7s;
  --medium-speed: calc(var(--small-speed) * 1.5);
  --large-speed: calc(var(--medium-speed) * 1.333);
  ...
  .small {
    animation: counter-rotation var(--small-speed) infinite linear;
  ...
  .medium {
    animation: rotation var(--medium-speed) infinite linear;
